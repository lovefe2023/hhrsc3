    ...
    <div className="flex-1 overflow-y-auto bg-slate-50 dark:bg-slate-950 pb-20">
      ...
      <section className="px-4 py-4 mb-6">
        ...
        <div className="grid grid-cols-2 gap-3">
          {[
            { id: 7, name: '洋河蓝色经典 海之蓝 52度', price: 188, tags: ['满减', '包邮'], img: 'https://images.unsplash.com/photo-1568213816046-0ee1c42bd559?q=80&w=400&auto=format&fit=crop' },
            { id: 8, name: '拉菲传奇 波尔多AOC 干红', price: 128, tags: ['热销', '包邮'], img: 'https://images.unsplash.com/photo-1585553616435-2dc0a54e271d?q=80&w=400&auto=format&fit=crop' },
